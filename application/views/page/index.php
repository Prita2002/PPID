...
<!-- Page Heading -->
            ...
            <div class="card shadow mb-3">
                <div class="card-header py-3">
                    <a href="<?= base_url('page/tambah') ?>" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i>Informasi Terbaru</a>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <tr class="text-justify">
                                    ...
                                    <td>
                                        <a data-toggle="modal" data-target="#edit<?= $admin->Content_id ?>"   class="btn btn-dark btn-sm"><i class="fas fa-edit"></i></a>
                                        <a href="<?= base_url('page/delete/' . $admin->Content_id) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda ingin hapus data ini ?')"><i class="fas fa-trash"></i></a>
                                    </td>
                                </tr>
                            </tbody>
                            <?php endforeach ?>
       ...
       <!-- Button trigger modal -->
         ...
         <!-- Modal -->
         <?php foreach ($page as $admin): $no++;?> 
        <div class="modal fade" id="edit<?= $admin->Content_id ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            <form action="<?= base_url('page/edit/'. $admin->Content_id) ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>Gambar</label>
                                    <input type="hidden" value="<?= $admin->Gambar; ?>" name="gambar_lama">
                                    <input type="file" name="Gambar" class="form-control" size="20" accept=".png,.jpg,.jpeg,.pdf">
